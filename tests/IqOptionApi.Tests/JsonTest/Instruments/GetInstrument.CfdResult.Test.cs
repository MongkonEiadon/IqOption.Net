...
{
    public class GetInstrument_CfdResult_Test : TestFor<LoadJsonFileTest>
    {
        ...
        public void TestSetup() {
            ...
            Json = CreateUnit().LoadJson("Json/Instruments/cfd.json");
        ...
        public void Test()
        {
            ...
            instrumentResult.Message.Type.Should().Be(InstrumentType.CFD);
        }
    }
}