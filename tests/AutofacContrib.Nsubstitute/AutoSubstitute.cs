...
namespace AutofacContrib.NSubstitute {
    ...
    public class AutoSubstitute : IDisposable
    {
        ...
        /// For advanced uses consider using directly <see cref="Substitute.For{T}"/> and then calling <see cref="Provide{TService}(TService)"/> so that type is used on dependencies for other Resolved types.
        /// </summary>
